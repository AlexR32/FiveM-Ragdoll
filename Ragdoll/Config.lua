...
ToggleControls = true -- Disable/Enable controls by default when logging into server (dont change value if server running, this will broke instructional buttons) (Default: true)
